...
/***/ function(module, exports, __webpack_require__) {
	...
	var raw_calendar_config = {
	    calendar_mode: 0,
	    show_out_range: false,
	    key_date: _index.utils.from_system_date(new Date()),
	    default_date: _index.utils.from_system_date(new Date()),
	    on_update_state: function on_update_state(state) {
	        console.log(state);
	    },
	    on_ok: function on_ok() {
	...
	var single_range_config = _extends({}, raw_calendar_config, {
	    show_out_range: true
	});
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(_index.RawCalendar, raw_calendar_config)
	    ),
	    _react2.default.createElement(
	        'div',
	        null,
	        ...
	        _react2.default.createElement(_index.SimpleCalendar, raw_calendar_config)
	    ),
	    _react2.default.createElement(
	        'div',
	        null,
	        ...
	        _react2.default.createElement(_index.SingleRangeCalendar, single_range_config)
	    ),
	    _react2.default.createElement(
	        'div',
	        null,
	        ...
	        _react2.default.createElement(_index.DoubleRangeCalendar, raw_calendar_config)
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constant = __webpack_require__(169);
	...
	var _tool = __webpack_require__(172);
	...
	var RawCalendar = _react2.default.createClass({
	  ...
	  propTypes: {
	    ...
	    calendar_mode: _react.PropTypes.number.isRequired,

	    // key date determines current month
	    key_date: _react.PropTypes.object.isRequired,

	    // today
	    default_date: _react.PropTypes.object.isRequired,

	    // a tuple of dates, selection can only be made in the valid range
	    valid_range: _react.PropTypes.array,

	    // a tuple of selected dates
	    selected_range: _react.PropTypes.array,

	    // callback for state changes after mouse hover & mouse leave & click on dates
	    on_update_state: _react.PropTypes.func.isRequired,

	    // customize selected date state change
	    selected_reducer: _react.PropTypes.func,

	    // whether to show out-of-range dates
	    show_out_range: _react.PropTypes.bool,
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    var self = this,
	        props_to_state = {
	      selected_dates: function selected_dates(a, b) {
	        return x.and.apply(null, x.zipWith(function (x, y) {
	          return c.compare_date(x, y) === 0;
	        }, a || [], b || []));
	      },
	      hovered_date: function hovered_date(a, b) {
	  ...
	  render: function render() {
	    ...
	    var calendar_mode = _self$props.calendar_mode;
	    var key_date = _self$props.key_date;
	    var default_date = _self$props.default_date;
	    var valid_range = _self$props.valid_range;
	    var selected_range = _self$props.selected_range;
	    var on_update_state = _self$props.on_update_state;
	    var selected_reducer = _self$props.selected_reducer;
	    var show_out_range = _self$props.show_out_range;
	    var styles = _self$props.styles;
	    var style = _self$props.style;
	    var _self$state = self.state;
	    var selected_dates = _self$state.selected_dates;
	    var hovered_date = _self$state.hovered_date;
	    var _default_date = default_date || c.from_system_date(new Date());
	    var mark_selected = x.map(function (d) {
	      var found = selected_dates.find(function (x) {
	        return c.date_equal(d, x);
	      });
	      return (show_out_range || !d.out) && found ? _extends({}, d, { selected: true }) : d;
	    });
	    var mark_hovered = x.map(function (d) {
	      return c.compare_date(hovered_date, d) === 0 ? _extends({}, d, { hovered: true }) : d;
	    });
	    var mark_defaulted = x.map(function (d) {
	      return (show_out_range || !d.out) && c.date_equal(_default_date, d) ? _extends({}, d, { defaulted: true }) : d;
	    });
	    var mark_banned = x.map(function (d) {
	      return c.date_in_range(d, valid_range) ? d : _extends({}, d, { banned: true });
	    });
	    var mark_range = x.map(function (d) {
	      return (selected_range || []).length !== 0 && (show_out_range || !d.out) && c.date_in_range(d, selected_range) ? _extends({}, d, { ranged: true }) : d;
	    });
	    var mark_not_this_month = x.map(function (d) {
	      return c.get_month(d) !== c.get_month(key_date) ? _extends({}, d, { out: true }) : d;
	    });
	    var weeks = x.compose(x.group(7), mark_range, mark_selected, mark_hovered, mark_defaulted, mark_banned, mark_not_this_month, c.padding_month_dates)(key_date);
	    ...
	    var default_selected_reducer = function default_selected_reducer(prev, x) {
	      switch (calendar_mode) {
	        case _constant.CALENDAR_MODE.SINGLE:
	          return [x];

	        case _constant.CALENDAR_MODE.MULTIPLE:
	          var index = prev.findIndex(function (d) {
	            return c.date_equal(d, x);
	          });
	          return index == -1 ? [].concat(_toConsumableArray(prev), [x]) : (prev.splice(index, 1), prev);
	    ...
	    styles = Object.assign({}, _style.calendar_styles, styles || {});
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            weekday_title.map(function (t) {
	              return _react2.default.createElement(
	                'li',
	                { key: t, style: (0, _style.get_style)(styles, ['day', 'weekday_title']) },
	                t
	              );
	            })
	          )
	        ...
	        weeks.map(function (week) {
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { style: styles.week },
	              week.map(function (d) {
	                var classes = ['day', d.defaulted ? 'default_day' : '', d.hovered ? 'hovered_day' : '', d.ranged ? 'ranged_day' : '', d.selected ? 'selected_day' : '', d.banned ? 'banned_day' : '', ['lt_month_day', '', 'gt_month_day'][1 + c.compare_month(d, key_date)]];

	                return _react2.default.createElement(
	                  'li',
	                  {
	                    key: JSON.stringify(d),
	                    style: (0, _style.get_style)(styles, classes),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleCalendar = _react2.default.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    var self = this,
	        props_to_state = {
	      key_date: function key_date(a, b) {
	        return c.compare_date(a, b) === 0;
	      }
	    };
	  ...
	  render: function render() {
	    ...
	    var key_date = self.state.key_date;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _range_calendar_utils = __webpack_require__(176);
	...
	var SingleRangeCalendar = _react2.default.createClass({
	    ...
	    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	        var self = this,
	            props_to_state = {
	            selected_range: function selected_range(a, b) {
	    ...
	    render: function render() {
	        var self = this;
	        var props = self.props;
	        var selected_range = self.state.selected_range;
	        var on_update_state = function on_update_state(state) {
	            var selected_range = rx.range_calendar_selected_range(state);

	            self.setState(_extends({}, state, { selected_range: selected_range }), function () {
	                (props.on_update_state || x.noop)(self.state);
	            });
	        };
	        var selected_reducer = rx.range_calendar_selected_reducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var range_calendar_selected_range = exports.range_calendar_selected_range = function range_calendar_selected_range(_ref) {
	    var selected_dates = _ref.selected_dates;
	    var hovered_date = _ref.hovered_date;
	    ...
	    switch (selected_dates.length) {
	        ...
	        case 1:
	            return (0, _calendar_utils.compare_date)(hovered_date, selected_dates[0]) == 1 ? [].concat(_toConsumableArray(selected_dates), [(0, _calendar_utils.offset_date)(hovered_date, -1)]) : [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DoubleRangeCalendar = _react2.default.createClass({
	    ...
	    render: function render() {
	        var self = this;
	        var _self$props = self.props;
	        var on_update = _self$props.on_update;
	        var valid_range = _self$props.valid_range;
	        var default_date = _self$props.default_date;
	        var styles = _self$props.styles;
	        var _self$state = self.state;
	        var selected_range = _self$state.selected_range;
	        var selected_dates = _self$state.selected_dates;
	        var key_date = _self$state.key_date;
	        var next_key_date = c.normalize_month(c.make_date(c.get_year(key_date), c.get_month(key_date) + 1, 1));
	        var selected_reducer = rx.range_calendar_selected_reducer;
	        var on_update_state = function on_update_state(state) {
	            var selected_range = rx.range_calendar_selected_range(state);
	        ...
	        var common_config = {
	            calendar_mode: _constant.CALENDAR_MODE.MULTIPLE,
	            show_out_range: false,
	            selected_reducer: selected_reducer,
	            selected_range: selected_range,
